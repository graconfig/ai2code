...
entity TaskType : cuid, managed {
  ...
  botTypes    : Composition of many BotType on botTypes.taskType = $self;
}
...
entity BotType : cuid, managed {
  ...
  prompts             : Association to many PromptText on prompts.botType = $self;
