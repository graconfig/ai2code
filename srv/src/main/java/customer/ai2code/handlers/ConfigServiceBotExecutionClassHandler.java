...
import cds.gen.configservice.BotExecutionClass_;
...
public class ConfigServiceBotExecutionClassHandler implements EventHandler {
    @On(event = CqnService.EVENT_READ, entity = BotExecutionClass_.CDS_NAME)
    public void getAllImplementedByClass(CdsReadEventContext context) throws IOException {
        ...
        // ReflectionUtils.
        implementedByClasses = ClassReflection.getClassbyInterface(BotExecution.class);
