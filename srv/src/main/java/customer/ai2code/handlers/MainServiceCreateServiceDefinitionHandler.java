...
public class MainServiceCreateServiceDefinitionHandler implements EventHandler {
    private final V0001 zsrvdGensrvd;
    private CreateServiceDefinitionBotExecution callodata = null;

    MainServiceCreateServiceDefinitionHandler(ContextService contextService, V0001 zsrvdGensrvd,
