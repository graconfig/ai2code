...
public class MainServiceCreateGenclasSeoHandler implements EventHandler {
    ...
    public void Read(CdsReadEventContext context) throws IOException {
        ...
        // " SELECT SINGLE CLASDESC INTO ev_clasdesc FROM ZTGENCLAS_L WHERE CLASNAME =
        // iv_clasname.\\n" +
        // " IF sy-subrc <> 0.\\n" +
        ...
        // " ENDMETHOD.\\n" +
        // "ENDCLASS.";
        // autoActiveCLASContext.setSourcecode(abapClassSource); //
        // 对应参考的AutoActiveCDSContext.setSource(Sources)
        ...
        // System.out.println("GenclasSeo SourceCode Preview=" +
        // abapClassSource.substring(0, 100) + "...");
    ...
    public void Create(CdsCreateEventContext context) throws IOException {
        ...
        // 示例：
        // ZcGenclasGlobalAutoActiveCLASContext context =
        // buildContextFromCreateRequest(context.getCqn());
        // String result = genclasSeoOdataExecutor.execute("genclas_seo_botid_001",
        // context);
