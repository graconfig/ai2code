...
@Component
public class ClaudeFunctionCallAdapter {
    /**
     * 将通用的函数信息转换为 Claude Tool Calling 格式
     */
    public List<Map<String, Object>> convertToClaudeFormat(List<FunctionInfo> functionInfos) {
        List<Map<String, Object>> claudeFunctions = new ArrayList<>();
        ...
        for (FunctionInfo functionInfo : functionInfos) {
            ...
            for (ParameterInfo paramInfo : functionInfo.getParameters()) {
                ...
                // 使用增强的类型信息
                String schemaType = paramInfo.getJsonSchemaType() != null ? paramInfo.getJsonSchemaType()
                        : mapJavaTypeToJsonType(paramInfo.getType());
