...
@Beta// CHECKSTYLE:OFF
public class TextContent implements MessageRequestContentPart 
// CHECKSTYLE:ON
{
  /**
   * Gets or Sets type
   ...
   */
  @Nonnull public TextContent type( @Nonnull final TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return The same instance of this {@link TextContent} class
   */
  @Nonnull public TextContent text( @Nonnull final String text) {
    this.text = text;
    return this;
  }
