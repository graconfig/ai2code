...
public class PromptServiceImpl implements PromptService {
    ...
    @Override
    public String parse(PromptTexts prompt, String taskId) {
        ...
        while (matcher.find()) {
            ...
            try {
                ...
                System.err.println("Failed to get context value for taskId: " + taskId + ", path: " + contextPath + ", error: " + e.getMessage());
    ...
    @Override
    public List<PromptTexts> getPrompts(String botTypeId, String taskId) {
        ...
        for (PromptTexts prompt : prompts) {
            String parsedText = parse(prompt, taskId);
