...
public class GenericCqnService {
    ...
    // --------------cds.gen.mainservice.BotInstances
    ...
    // --------------cds.gen.mainservice.BotMessages
    public BotMessages createAndInsertBotMessage(String role, String message, String ragData, String botInstanceId) {
        ...
        botMessage.setRagData(ragData); // Created
    ...
    public List<BotMessages> getBotMessagesByBotInstance(String botInstanceId) {
    ...
    // --------------cds.gen.mainservice.ContextNodes
    ...
    // --------------cds.gen.configservice.ModelConfigs
    ...
    // --------------cds.gen.configservice.BotTypes
