...
public class GenericCqnService {
    ...
    public String findMatchingViewsByScenario(String ragSource, int ragTopK, String query,
        ...
        CqnSelect selectScenario = Select.from("MainService.BusinessScenarios")
                // .columns(b -> b.get("scenario"), b -> b.get("description"), b ->
                // b.get("viewCategory"))
                .columns("scenario", "description", "viewCategory")
        ...
        // List<BusinessScenarios> scenarioRows =
        // mainService.run(selectScenario).listOf(BusinessScenarios.class);
        // List<BusinessScenarios> scenarioRows =
        // persistenceService.run(selectScenario).listOf(BusinessScenarios.class);
