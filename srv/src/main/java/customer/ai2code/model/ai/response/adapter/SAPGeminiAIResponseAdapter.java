...
public class SAPGeminiAIResponseAdapter implements AIResponse {
    private final String content;

    private ObjectMapper objectMapper;
    // private final String stopReason;

    public SAPGeminiAIResponseAdapter(InvokeResponse response) {
        this.content = extractContentFromInvokeResponse(response);
        // this.stopReason = response.getStopReason().getValue();
    }

    public SAPGeminiAIResponseAdapter(ConverseResponse response, ObjectMapper objectMapper)
