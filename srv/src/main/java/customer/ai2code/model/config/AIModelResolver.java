...
public class AIModelResolver {
    ...
    public AIModelResolver(GenericCqnService genericCqnService, SAPOpenAIServiceImpl sapOpenAIService,
    ...
    // default -> {
    // // 记录警告日志
    // System.out.println("Unknown model name: " + modelName + ", using default
    // GPT-3.5-turbo");
    ...
    public AIService resolveAIService(String modelConfigId) {
        ...
        // 1. 从配置服务中获取模型配置
        ModelConfigs modelConfigs = genericCqnService.getModelConfig(modelConfigId);
